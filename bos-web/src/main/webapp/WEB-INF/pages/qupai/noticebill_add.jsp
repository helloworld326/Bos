...
<script type="text/javascript">
	$(function(){
		...
		$("input[name='telephone']").keyup(function(){
			...
			$.post("noticebill_findCustomerByTelephone", {"telephone":phone}, function(data){
					if (data != null) {
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="noticebill_add" method="post">
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
					<td>来电号码:</td>
					<td><input type="text" class="easyui-validatebox" name="telephone" required="true" /></td>
					<td>客户编号:</td>
