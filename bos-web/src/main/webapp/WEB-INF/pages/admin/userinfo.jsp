...
<script type="text/javascript">
	$(function(){
		$.post("${pageContext.request.contextPath}/role_findAll", function(data){
			for(var i = 0; i < data.length; i++){
				var id = data[i].id;
				var name = data[i].name;
				$("#roleId").append('<input name="roleIds" type="checkbox" id="' + id + '" value="' + id + '" /><label for="' + id + '">' + name + '</label>');
			}
		});
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="saveForm" method="post" action="user_add" >
