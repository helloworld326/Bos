...
//			url : '${pageContext.request.contextPath}/json/menu.json',
			url : '${pageContext.request.contextPath}/function_findMenu',
			type : 'POST',
			dataType : 'text',
		...
		$("#btnEp").click(function(){
			...
			if (b) {
				...
				if (v1 == v2) {
					$.post("user_editPassword", {"password" : v1}, function(data){
						if (data == "1") {
							// 密码修改成功
							$("#editPwdWindow").window("close");	
						} else {
        ...
        <div class="easyui-layout" fit="true">
            ...
            <form id="editPwdForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input name="" id="txtNewPass" data-options="validType:'length[6,12]'" type="Password" required="true" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input name="" id="txtRePass" type="Password" data-options="validType:'length[6,12]'" required="true" class="txt01 easyui-validatebox" /></td>
                    </tr>
                </table>
              </form>
            </div>
